...
spolehlivý. Dá se nicméně pořídit pomocí nástroje UDPipe\cite{udpipe}\footnote{%
...
řidčeji. Píšu je záměrně s~malymi
...
nitra\cite{teresa1588castillo} podle sv. Terezie z~Avily.
...
uvádím. Co znamená, že Ježíš je cesta, pravda a život, Makoň obsáhle vykládá v~pasáži
...
Chyby, kterých se církev v~historii dopustila, je zahrnuta do Božího plánu a za
symbol je tomu připsáno vůdcovství svatého Petra.
