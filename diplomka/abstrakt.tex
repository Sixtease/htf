...
života burcováním k~zasvěcení života hledání Království Božího. V~desítkách
...
zákonitým jevem.`` Pomocí počátačové analýzy přepisů nahrávek lze dospět
k~seznamu kandidátských témat, jenž může být základem pro vyčerpávající seznam
pokrývající celý mluvený korpus. V~mluveném korpusu Karla Makoně lze nalézt
odpovědi na všechny základní otázky systematické teologie. Mnohé z~těchto
odpovědí jsou v~kontroverzi k~církevním naukám. Esence Makoňova poselství lze
shrnout starověkým citátem ,,Tento život je mostem do věčnosti.`` Jiní jeho
příznivci uvádějí ale jiná shrnutí.
}
