...
jógy\cite{aurobindo1999synthesis} a komentuje jeho dílo ve své knize Srovnání
  jógy s~křesťanskou mystikou\cite{KaMaGhos}, a od Wattse přeložil hned čtyři tituly: Cestu
zen\cite{watts1957way}, Moudrost nejistoty\cite{watts1951wisdom}, Přírodu, muže a
ženu\cite{watts1973nature} a Svrchovanou totožnost\cite{watts1950supreme}.
...
jógou\cite{yesudian1974self}. U odtělesňování představuje Makoňův pojem
...
od Karla Makoně lze doporučit jeho překlad a komentář ke knize Zlatý
